...
#    sit_pos = X_regrid.trunc_state_info['sit_sfc_OImon']['pos']
#    sit_pos = X_regrid.trunc_state_info['sit_noMV_OImon']['pos']
    ...
    [prior_mpi_tas_regrid,
     lat_mpi_tas_new,
     lon_mpi_tas_new] = lmr.regrid_esmpy(cfg_mpi.prior.esmpy_grid_def['nlat'],
    ...
    recon_start = cfg_ccsm4.core.recon_period[0]
    recon_end = cfg_ccsm4.core.recon_period[1]
    ...
    if cfg_ccsm4.prior.state_variables['tas_sfc_Amon'] == 'full':
